...
import { listStaffMembers } from '@/lib/queries';
        ...
        <div className="container mx-auto container-padding">
          <FadeIn className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              At SGIS, we believe education is about more than acquiring
              knowledge — it is about developing the skills and character
              necessary to become responsible, contributing members of society.
            </p>
          </FadeIn>
        </div>
      </section>
            ...
            <FadeIn direction="left">
              <div className="space-y-5">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  At SGIS, we believe in providing an exceptional education that
                  not only prepares our students for the future but also
                  enriches their lives in the present. Our dedicated faculty and
                  staff work tirelessly to create a learning environment that is
                  engaging, challenging, and supportive. Our mission is to
                  provide an environment that inspires our students to achieve
                  their full potential.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  We are committed to ensuring that every student who enters our
                  doors feels valued, supported, and empowered to succeed. To
                  us, education is not only about acquiring knowledge but also
                  about developing the skills and character traits necessary to
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {staff.map((member) => (
                <FadeIn key={member.id}>
                  <article className="overflow-hidden rounded-2xl border border-border bg-card shadow-brand-sm">
                    <img
                      src={member.imageUrl}
                      alt={member.name}
