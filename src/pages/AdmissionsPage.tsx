          ...
          <FadeIn className="max-w-3xl">
            ...
            <div className="mt-8">
              <Button
                asChild
                size="lg"
                className="gap-2 font-medium shadow-brand-md"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <FadeIn direction="left">
              <div className="space-y-6">
                <h2 className="text-h3 font-serif font-semibold text-foreground">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={g}
                      className="rounded-lg border border-border/60 bg-muted/30 px-3 py-2 text-center text-sm font-medium text-foreground hover:border-primary/30 hover:bg-primary/5 transition-colors"
                    >
                      {g}
                    </div>
                  ))}
                ...
                <p className="text-sm text-muted-foreground">
                  Subject to availability. Contact admissions for current
                  vacancies.
                </p>
              </div>
            </FadeIn>
