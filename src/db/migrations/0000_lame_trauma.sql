CREATE TYPE "public"."announcement_audience" AS ENUM('public', 'students', 'parents', 'applicants', 'admins');--> statement-breakpoint
CREATE TYPE "public"."content_status" AS ENUM('draft', 'published', 'archived');--> statement-breakpoint
CREATE TYPE "public"."application_period_status" AS ENUM('upcoming', 'open', 'closed', 'archived');--> statement-breakpoint
CREATE TYPE "public"."application_status" AS ENUM('draft', 'pending_payment', 'submitted', 'under_review', 'approved', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."exam_attempt_status" AS ENUM('not_started', 'in_progress', 'submitted', 'expired', 'graded');--> statement-breakpoint
CREATE TYPE "public"."exam_status" AS ENUM('draft', 'active', 'closed', 'archived');--> statement-breakpoint
...
CREATE TYPE "public"."gallery_visibility" AS ENUM('public', 'private');--> statement-breakpoint
CREATE TYPE "public"."payment_purpose" AS ENUM('entrance_exam_registration', 'school_fees', 'admission_fee', 'other');--> statement-breakpoint
CREATE TYPE "public"."payment_status" AS ENUM('pending', 'submitted', 'approved', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."gender" AS ENUM('male', 'female', 'other');--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('student', 'parent', 'admin', 'super_admin');--> statement-breakpoint
...
ALTER TABLE "application_periods" ADD CONSTRAINT "application_periods_created_by_profiles_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "applications" ADD CONSTRAINT "applications_application_period_id_application_periods_id_fk" FOREIGN KEY ("application_period_id") REFERENCES "public"."application_periods"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "applications" ADD CONSTRAINT "applications_reviewed_by_profiles_id_fk" FOREIGN KEY ("reviewed_by") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "exam_attempts" ADD CONSTRAINT "exam_attempts_application_id_applications_id_fk" FOREIGN KEY ("application_id") REFERENCES "public"."applications"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "cms_pages" ADD CONSTRAINT "cms_pages_updated_by_profiles_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "news_articles" ADD CONSTRAINT "news_articles_created_by_profiles_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "exams" ADD CONSTRAINT "exams_application_period_id_application_periods_id_fk" FOREIGN KEY ("application_period_id") REFERENCES "public"."application_periods"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "gallery_items" ADD CONSTRAINT "gallery_items_created_by_profiles_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payments" ADD CONSTRAINT "payments_approved_by_profiles_id_fk" FOREIGN KEY ("approved_by") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "admission_settings" ADD CONSTRAINT "admission_settings_updated_by_profiles_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
