    ...
    setPeriods((prev) => [
      {
        ...
        description: null,
        applicationStartDate: new Date(nextPeriod.applicationStartDate).toISOString(),
        applicationEndDate: new Date(nextPeriod.applicationEndDate).toISOString(),
        examStartDate: new Date(nextPeriod.examStartDate).toISOString(),
        examEndDate: new Date(nextPeriod.examEndDate).toISOString(),
