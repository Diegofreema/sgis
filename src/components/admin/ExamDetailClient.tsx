...
import type { QuestionBankItem as Question } from '@/lib/admin-questions';
type ApplicationPeriod = { id: string; title: string; examStartDate: string; examEndDate: string; status: string };
...
export function ExamDetailClient({
  ...
  async function handleSave() {
    ...
    if (isNew) {
      navigate({ to: '/admin/exams/$id', params: { id: (result.data as { id: string }).id } });
    } else {
      onChanged();
    }
  }
