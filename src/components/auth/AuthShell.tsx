...
/**
 * Shared decorative auth/account layout — equivalent to legacy
 * app/(auth)/layout.tsx and app/(account)/layout.tsx (identical panel).
 * The (auth) redirect-if-authed guard is applied via the route's beforeLoad.
 */
