...
export function ProfileFormClient({ actor, profile, isManagingStudent }: Props) {
  ...
  const readOnlyProfile = studentMustChangePassword;
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      gender: (profile.gender ?? undefined) as
        | "male"
        | "female"
        | "other"
        | undefined,
    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input disabled={readOnlyProfile} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="tel" disabled={readOnlyProfile} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="date" disabled={readOnlyProfile} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" disabled={readOnlyProfile} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <Button type="submit" className="font-medium" disabled={form.formState.isSubmitting || readOnlyProfile}>
      ...
      {actor.role === "parent" && !isManagingStudent && (
