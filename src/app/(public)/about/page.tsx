...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn about Sankt Georg International School — our mission, values, and programmes.",
};
    ...
    <>
      ...
      <Suspense fallback={
        <div className="section-padding relative overflow-hidden bg-primary/90 animate-pulse">
          <div className="container mx-auto container-padding"><div className="h-52" /></div>
        </div>
      }>
        <AdmissionCTA />
      </Suspense>
