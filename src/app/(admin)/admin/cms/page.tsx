...
const PAGE_KEYS = [
  { key: "homepage", label: "Homepage", description: "Hero section, school intro, mission and vision" },
  { key: "about", label: "About Us", description: "School history, values, and leadership" },
  { key: "admissions", label: "Admissions", description: "Requirements, process, and fees" },
  { key: "contact", label: "Contact", description: "Address, phone, and office hours" },
  { key: "mission", label: "Mission Statement", description: "Core mission text" },
  { key: "vision", label: "Vision Statement", description: "Long-term vision text" },
];
      ...
      <FadeIn>
        <div className="grid md:grid-cols-2 gap-4">
          {PAGE_KEYS.map((page) => {
            ...
            return (
              <Card key={page.key} className="border-border/60 hover:border-primary/30 hover:shadow-brand-sm transition-all">
